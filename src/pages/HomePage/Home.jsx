...
import PostFilter from './components/PostFiltersForm/PostFilter';
import Clock from './components/Clock/Clock';
import ClockOther from './components/Clock/ClockOther';
import MagicBox from './components/ColorBox/MagicBox';
  ...
  return (
    ...
    <div className="App">
      <header className="App-header">
        ...
        <PostFilter onSubmit= {handleFiltersChange}/>
        <Pagination 
